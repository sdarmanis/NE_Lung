...
```{r Clean WS and import}
rm(list=ls())
data_adult <- read.table("/Volumes/GoogleDrive/My Drive/NE_Lung/processed_input/GC_table_adult_NE.tsv", header=T, row.names = 1, check.names = F)
meta_adult_new <- read.table("/Volumes/GoogleDrive/My Drive/NE_Lung/processed_input/Metadata_table_adult_NE.tsv", row.names = 1, header=T, check.names = F)
...
ggsave(plot = pca.scatter, filename = "/Volumes/GoogleDrive/My Drive/NE_Lung/plot_out/NE02/PCA_scatterplots_largefile.pdf",width = 15, height = 12)
```
