...
Save data and metadata 
```{r }
write.table(data_adult_ND, paste(dir,"input/GC_table_adult_NE_ND.tsv",sep=""))
write.table(meta_adult_new_ND, paste(dir,"input/Metadata_table_adult_NE_ND.tsv",sep=""))
```
