...
Load data 
```{r Load data}
data_adult <- read.table(paste(dir,"input/secondary_input/GC_table_ALL_datasets_renamed_ND.tsv",sep=""))
meta_adult_new <- read.table(paste(dir,"input/secondary_input/Metadata_ALL_datasets_renamed_ND.tsv",sep=""))
```
...
Save object 
```{r}
save(tiss,file=paste(dir,"input/R_objects/All_datasets_renamed_ND.RData",sep=""))
```
