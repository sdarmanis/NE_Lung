...
```{r Load data}
data_adult <- read.table(paste(dir,"input/GC_table_adult_NE_from_old_ND.tsv",sep=""))
meta_adult_new <- read.table(paste(dir,"input/Metadata_table_adult_NE_from_old_ND.tsv",sep=""))
```
...
```{r Write tables}
write.table(data.temp, paste(dir,"input/GC_table_ALL_datasets_ND.tsv",sep=""))
write.table(meta.temp, paste(dir,"input/Metadata_ALL_datasets_ND.tsv",sep=""))
```