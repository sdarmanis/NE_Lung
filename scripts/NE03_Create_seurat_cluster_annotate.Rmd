---
title: "I02_Create_Seurat_cluster_annotate"
...
Load Seurat object
Change "~/Documents/Labwork/Projects/Biohub/NE_Lung/processed_input/NE_Lung_Seurat_R_object.RData" with the location of the object on 
your computer
```{r Import}
rm(list=ls())
load("~/Documents/Labwork/Projects/Biohub/NE_Lung/processed_input/NE_Lung_Seurat_R_object.RData")
tiss
```

Remove Scrublet doublets
I am saving the original object with doublets included as tiss.with.d and that object can be used to analyze the doublets along
with the singlets. 
If only looking at singlets than use object tiss (used by default in the rest of the script)
```{r Remove doublets}
tiss.with.d <- tiss
cells <- row.names(tiss@meta.data)[which(tiss@meta.data$scrublet_doublet == F)]
...
Save object 
```{r}
save(tiss,file="~/Documents/Labwork/Projects/Biohub/NE_Lung/processed_input/NE_Lung_Seurat_R_object_no_doublets.RData")
```
